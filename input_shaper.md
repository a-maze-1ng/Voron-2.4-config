...
```~/klipper/scripts/calibrate_shaper.py /tmp/resonances_x_20221206_190149.csv -o /tmp/shaper_calibrate_x.png```  
```~/klipper/scripts/calibrate_shaper.py /tmp/resonances_y_20221206_190505.csv -o /tmp/shaper_calibrate_y.png```  
