...
```~/klipper/scripts/calibrate_shaper.py /tmp/resonances_x_20230402_193430.csv -o /tmp/shaper_calibrate_x.png```  
```~/klipper/scripts/calibrate_shaper.py /tmp/resonances_y_20230402_194618.csv -o /tmp/shaper_calibrate_y.png```  
