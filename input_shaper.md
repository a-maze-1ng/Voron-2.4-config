...
```~/klipper/scripts/calibrate_shaper.py /tmp/resonances_x_20221223_163108.csv -o /tmp/shaper_calibrate_x.png```  
```~/klipper/scripts/calibrate_shaper.py /tmp/resonances_y_20221223_163342.csv -o /tmp/shaper_calibrate_y.png```  
