...
```~/klipper/scripts/calibrate_shaper.py /tmp/resonances_x_20240320_205035.csv -o "/tmp/2024-03-20 - shaper_calibrate_x.png"```  
```~/klipper/scripts/calibrate_shaper.py /tmp/resonances_y_20240320_205347.csv -o "/tmp/2024-03-20 - shaper_calibrate_y.png"```  
